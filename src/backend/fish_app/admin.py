...
class TimetableAdmin(admin.ModelAdmin):
    list_display = ('id', 'uuid', 'name', 'value')
    search_fields = ('name', 'value', 'uuid')

@admin.register(Feeding)
class FeedingAdmin(admin.ModelAdmin):
    list_display = ('id', 'uuid', 'pool', 'feed', 'weight', 'period', 'status')
    list_filter = ('status', 'pool', 'feed', 'period')
    search_fields = ('uuid',)

@admin.register(Log)
class LogAdmin(admin.ModelAdmin):
    list_display = ('id', 'uuid', 'action', 'when', 'type')
...
class UserAdmin(admin.ModelAdmin):
    list_display = ('id', 'uuid', 'login', 'fullname')
