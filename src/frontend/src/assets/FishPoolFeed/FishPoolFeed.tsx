...
const FishPoolFeed: React.FC<FishPoolFeedProps> = ({
    width = "24px",
    height = "24px",
    fill = "#00000",
    withBubles = true,
    ...
    return (
        <svg
            ...
            viewBox="0 0 15.314 15.314"
        >
            <g>
                <g>
                    {withBubles && <circle style={{ fill }} cx="11.71" cy="5.655" r="0.656" />}

                    <path
                        style={{ fill }}
                        d="M14.109,2.793h0.084c0.219,0,0.397-0.179,0.397-0.398V1.326c0-0.221-0.179-0.398-0.397-0.398H1.12
			...
			c0.174,0.609,0.268,1.242,0.268,1.891C14.518,10.699,11.442,13.776,7.658,13.776z"
                    ...
                    <path
                        style={{ fill }}
                        d="M7.787,8.836c-0.001,0.005-0.099-0.01-0.312-0.06C7.447,8.769,7.416,8.765,7.386,8.761
			...
			C8.717,10.116,8.578,10.253,8.409,10.253z"
                    />
                    {withBubles && <circle style={{ fill }} cx="10.217" cy="8.278" r="0.837" />}
                </g>
            </g>
        </svg>
    );
